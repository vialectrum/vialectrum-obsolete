...
REQUEST_HEADERS = {'Accept': 'application/viacoin-paymentrequest', 'User-Agent': 'Vialectrum'}
ACK_HEADERS = {'Content-Type':'application/viacoin-payment','Accept':'application/viacoin-paymentack','User-Agent':'Vialectrum'}
...
def load_certificates():
    try:
        ...
        print "ca-bundle.crt file should be placed in ~/.vialectrum/ca/ca-bundle.crt"
...
class PaymentRequest:
    ...
    def send_ack(self, raw_tx, refund_addr):
        ...
        paymnt.memo = "Paid using Vialectrum"
